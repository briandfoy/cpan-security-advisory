# created by util/generate at Mon Aug  3 11:24:02 2026
# https://github.com/briandfoy/cpan-security-advisory.git 234879e126c2ff7fbe6eb32e1da5f4cee10b1992
...
our $VERSION = '20260803.001';

sub db {
	{"dists" => {"" => {"advisories" => [],"main_module" => "","versions" => []},"perl" => {"main_module" => "perl"}},"meta" => {"commit" => "234879e126c2ff7fbe6eb32e1da5f4cee10b1992","date" => "Mon Aug  3 11:24:02 2026","epoch" => 1785756242,"generator" => "util/generate","repo" => "https://github.com/briandfoy/cpan-security-advisory.git"},"module2dist" => {}}
}
